...
var send = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _e, NETCORE_API, EMAIL_FROM, EMAIL_NAME, options, response, error_1;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    _e = process.env, NETCORE_API = _e.NETCORE_API, EMAIL_FROM = _e.EMAIL_FROM, EMAIL_NAME = _e.EMAIL_NAME;
                    _f.label = 1;
                case 1:
                    _f.trys.push([1, 3, , 4]);
                    options = {
                    ...
                    return [4 /*yield*/, (0, node_fetch_1["default"])('https://api.pepipost.com/v5.1/mail/send', options)];
                case 2:
                    response = _f.sent();
                    return [2 /*return*/, response.status === 202];
                case 3:
                    error_1 = _f.sent();
